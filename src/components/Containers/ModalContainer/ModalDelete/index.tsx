...
import ButtonDelete from 'src/components/Atomic/Button/ButtonDelete'
...
const OpModalDelete = ({ handleCancel, isLoading = false, handleConfirm, recordModal }: Props) => {
      ...
      <ModalFooterContainer
        array={[
          <>
            ...
            <ButtonDelete isLoading={isLoading} onClick={handleConfirmOk} />
          </>
        ]}
      />
    ),
